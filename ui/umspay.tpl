        ...
        <div class="col-sm-12 col-md-12">
            <div class="panel panel-primary panel-hovered panel-stacked mb30">
                <div class="panel-heading">
                    <div class="panel-title">{Lang::T('UMSPay Settings')}</div>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">{Lang::T('Login to')} <a href="https://portal.umeskiasoftwares.com/" target="_blank">https://portal.umeskiasoftwares.com</a> {Lang::T('to get your api key on settings page')}</small>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">{Lang::T('Enter your email address that you used to register on')} <a href="https://portal.umeskiasoftwares.com/" target="_blank">https://portal.umeskiasoftwares.com</a></small>
                        </div>
                    </div>
                    
                    <div class="form-group">
                        <label class="col-md-2 control-label">{Lang::T('Account ID')} <small class="text-info">(Optional)</small></label>
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">{Lang::T('Login to')} <a href="https://portal.umeskiasoftwares.com/servicepoint.php?ptd=umspay&account" target="_blank">https://portal.umeskiasoftwares.com</a> {Lang::T('to get your account id on settings page')}</small>
                            <br>
                            <span class="text-info">{Lang::T('This is optional, if your account has one copy and paste it here')}</span>
                        </div>
                    </div>
