                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <small class="form-text text-muted">Login to <a href="https://portal.umeskiasoftwares.com/" target="_blank">https://portal.umeskiasoftwares.com</a> {Lang::T('to get your api key on settings page')}</small>
                        </div>
                    </div>
                    <div class="form-group">
